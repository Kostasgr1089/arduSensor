...
SECRET_KEY = 'django-insecure-qwi5o#0h8r1d3e9h030#bhwio=*km4$_w*slu_i0^=q8)n$@-('
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.SessionAuthentication',  # Keep this for browser login
    ]
}
...
LOGIN_URL = 'login'
LOGIN_REDIRECT_URL = '/api/display-data/'  # Redirect to homepage after login
